...
1. Install the [current release](https://github.com/zer0Kerbal/MiniSampleReturnCapsule/releases/latest) if you have not already
...
2. Navigate to the [Localization folder](https://github.com/zer0Kerbal/MiniSampleReturnCapsule/GameData/MiniSampleReturnCapsule/Localization)
