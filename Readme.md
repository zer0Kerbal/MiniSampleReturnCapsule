...
##### Also available on [CKAN][CKAN:url] as _`MiniSampleReturnCapsule`._

# Mini Sample Return Capsule (MSRC) 

Two part size zero (0.625m) autonomous return capsule to stuff your experiments in for Kerbal Space Program.  

#### Adopted for curation by [`@zer0Kerbal`][LINK:zer0Kerbal], originally by [`@CobaltWolf`][LINK:cobaltwolf] and [`@AlbertKermin`][LINK:albertkermin]  
...
See the [README in the Localization folder][LINK:localization] for instructions for adding or improving translations for languages other than English. [GitHub][GitHub:url] push is the best way to contribute.
...
#### Mods that benefit Mini Sample Return Capsule (MSRC)
...
- [x]  [Kerbal Operating System (kOS)][thread:kos]
- [x]  [RemoteTech][thread:rt]  
- [x]  [Tarsier Space Tech][thread:tss]  
...
> License: [![License SimpleBSD-2][LICENSE:orig:shld]][LICENSE:orig:url] 
...
###### v1.4.1.0 original: 01 Oct 2019 zed'K | updated: 15 Sep 2021 zed'K

<!-- mod links -->
[MOD:license]:https://github.com/zer0Kerbal/MiniSampleReturnCapsule/blob/master/LICENSE

[MOD:wiki]: https://github.com/zer0Kerbal/MiniSampleReturnCapsule/ "Wiki"
...
[CKAN:shd]: https://img.shields.io/badge/CKAN-MiniSampleReturnCapsule-blue.svg?labelColor=black&style=plastic "CKAN"
